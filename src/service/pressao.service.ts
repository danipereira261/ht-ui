...
export class PressaoService {
    ...
    public salvar(model: PressaoModel) {
        ...
        // return this.http.post(`https://ht-app-back.herokuapp.com/api/v1/registro-pressao-arterial` , pesoModel);
    }
    ...
    public deletById(id: number ) {
        ...
        // return this.http.get('https://ht-app-back.herokuapp.com/api/v1/registro-pressao-arterial/?id=' + cpf);
    }
}